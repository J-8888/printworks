...
```bash
verdent-image edit --model gpt-image-2 --image /project/verdent-design/stage1/comp-2-editorial.png --prompt "Design the pricing page in the same visual style, type system, palette, grid, material language, and brand tone as the selected reference image. Create one complete page comp, not a style exploration."
```
